...
import { CreateAmenityDto } from '../dtos/amenity.dto';
...
class AmenityRoute {
    ...
    initializeRoutes() {
        ...
        */
         ...
         */
        this.router.post(`${this.path}`, authMiddleware, authoriztionMddlewareFactory(['propertiesFullAccess', 'propertiesModifyAccess']), validationMiddleware(CreateAmenityDto), this.amenityController.createAmenity);
        /**
         * @swagger
         * /property/search:
         *   post:
         ...
         *               $ref: '#/components/schemas/property'
         */
        this.router.get(`${this.path}`, this.amenityController.getAmenities);
        /**
         * @swagger
         * /property/{id}:
         *   paths:
         ...
         */
        this.router.get(`${this.path}/:id`, authMiddleware, authoriztionMddlewareFactory(['propertiesFullAccess', 'propertiesModifyAccess']), this.amenityController.getAmenityById);
        /**
         * @swagger
         * path:
         *  /property:
         ...
         *                $ref: '#/components/schemas/errorSchema'
         */
        this.router.put(`${this.path}/:id`, authMiddleware, authoriztionMddlewareFactory(['propertiesFullAccess', 'propertiesModifyAccess']), validationMiddleware(CreateAmenityDto, true), this.amenityController.updateAmenity);
        /**
         * @swagger
         * /property/{id}:
         *   paths:
         ...
         */
        this.router.delete(`${this.path}/:id`, authMiddleware, authoriztionMddlewareFactory(['propertiesFullAccess']), this.amenityController.deleteAmenity);
        this.router.post(`${this.path}/uploadImage`, authMiddleware, authoriztionMddlewareFactory(['propertiesFullAccess', 'propertiesModifyAccess']), upload.single('asset'), this.amenityController.uploadImage);
    }
}
export default AmenityRoute;
//# sourceMappingURL=amenity.route.js.map